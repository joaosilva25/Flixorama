  ...
  return (
    <ProtectRoute>
      <div className="bg-gray-900 h-full">
        <ShowMoviesGenres genreCode={35} genreName="Comedia" genrePage={page} />
        <div className="w-full relative bottom-24 flex justify-end p-6 xs:h-24 sm:h-24">
          <div className="flex w-72 gap-4 xs:w-36 sm:w-36">
            <div className="h-12 w-12 border-2 border-cyan-500 first:flex justify-center items-center xs:w-8 xs:h-8 sm:w-8 sm:h-8">
              <button
